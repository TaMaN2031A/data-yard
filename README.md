...
| Data Analysis (Pandas) | indexing, grouping, reshaping, time series basics | pandas, numpy | [Python for Data Analysis/python_for_data_analysis.ipynb](Python%20for%20Data%20Analysis/python_for_data_analysis.ipynb) |
| NLP | tokenization, embeddings intro, classic NLP workflow | pandas, numpy, visualization libs | [NLP/jurafsky_nlp_book.ipynb](NLP/jurafsky_nlp_book.ipynb) |
...
| Haystack (RAG/Agents) | pipelines, components, tool-calling agents | haystack (version TBD) | [haystack/getting_start.py](haystack/getting_start.py), [Pipelines/](haystack/Pipelines/), [Agents/](haystack/Agents/) |
