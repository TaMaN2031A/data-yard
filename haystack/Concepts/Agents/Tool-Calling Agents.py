...
web_tool = ComponentTool(component=web_search,
                         name="web_search",
                         description="Search the web for current.txt information like weather, news, or facts.")
tool_calling_agent = Agent(
    ...
    system_prompt="""You're a helpful agent. When asked about current.txt information like weather, news, or facts, 
