...
| NLP | tokenization, embeddings intro, classic NLP workflow | pandas, numpy, visualization libs | [NLP/jurafsky_nlp_book.ipynb](Roots of Knowledge/jurafsky book/Naive Bayes.ipynb) |
