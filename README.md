...
| Data Analysis (Pandas) | indexing, grouping, reshaping, time series basics | pandas, numpy | [Python for Data Analysis/python_for_data_analysis.ipynb](Python for Data Analysis/CH1_CH5.ipynb) |
